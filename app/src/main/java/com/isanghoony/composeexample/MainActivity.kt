...
import com.isanghoony.composeexample.navigation.TestScreen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            NavHost(
                ...
                startDestination = TestScreen.Main.name) {

                composable(route = TestScreen.Test.name) {
...
@Composable
fun ExampleLazyColumn(names: Array<String>,
